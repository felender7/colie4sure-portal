...
class GaragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garage" do
    assert_difference('Garage.count') do
      post garages_url, params: { garage: { license_plate: @garage.license_plate, make: @garage.make, model: @garage.model, year: @garage.year } }
    end
  ...
  test "should update garage" do
    patch garage_url(@garage), params: { garage: { license_plate: @garage.license_plate, make: @garage.make, model: @garage.model, year: @garage.year } }
